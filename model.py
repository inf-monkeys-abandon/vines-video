...
from ours_pipeline_zeroflicks import oursControlPipelineZeroFlicks
...
class Model:
    def __init__(self, device, dtype, **kwargs):
        ...
        self.pipe_dict = {
            ModelType.ZeroFlicksCanny: oursControlPipelineZeroFlicks,
            ModelType.ZeroFlicksCannyDB: oursControlPipelineZeroFlicks,
            ModelType.ZeroFlicksPose: oursControlPipelineZeroFlicks,
            ModelType.ZeroFlicksDepth: oursControlPipelineZeroFlicks,
        }
    ...
    def set_model(self, model_type: ModelType, model_id: str, **kwargs):
        ...
        self.pipe = self.pipe_dict[model_type].from_pretrained(
            model_id, safety_checker=safety_checker, local_files_only=False, torch_dtype=torch.float16, **kwargs).to(self.device)
        # st()
    ...
    def process_zeroflicks_canny(self,
                                 video_path,
                                 prompt,
                                 chunk_size=8,
                                 watermark='Text2Video-Zero',
                                 merging_ratio=0.0,
        ...
        # extract flow from control video
        flow = None
        if flow_latent:
    ...
    def process_zeroflicks_canny_db(self,
                                    db_path,
                                    video_path,
                                    prompt,
                                    chunk_size=8,
    ...
    def process_zeroflicks_depth(self,
                                 video_path,
                                 prompt,
                                 chunk_size=8,
                                 watermark='Text2Video-Zero',
    ...
    def process_zeroflicks_pose(self,
            video_path,
            prompt,
            chunk_size=8,
            watermark=True,
        ...
        if self.model_type != ModelType.ZeroFlicksPose:
            controlnet = ControlNetModel.from_pretrained(
